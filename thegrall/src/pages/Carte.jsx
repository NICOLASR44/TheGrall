...
import WeatherWidget from "../components/Meteo";
      ...
      <div>
        <div className="carteContainer">
          ...
          <div className="mapBroceliande">
            <img src="src\assets\map Brocéliande.jpg" alt="carte du pays de Brocéliande" className="mapBroceliande" />
        ...
        <div className="meteo">
          <img className="meteoCamelot" src="src\assets\Meteo.jpg" alt="meteoCamelotImage" />
          <WeatherWidget />
        </div>
      </div>
    </>
